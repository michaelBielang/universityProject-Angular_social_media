...
import { ClientJobModelDetailsComponent } from './components/client/client-job-details/client-job-details-infos/client-job-model-details/client-job-model-details.component';
...
@NgModule({
  declarations: [
    ...
    FeedbackComponent,
    LotteryComponent,
    ClientJobModelDetailsComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
